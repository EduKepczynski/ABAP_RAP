...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx = CORRESPONDING zekf_s_leg_travel( <entity> MAPPING FROM ENTITY ).
...
CLASS lsc_ZEKF_DD_LEG_TRAVEL DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZEKF_DD_LEG_TRAVEL IMPLEMENTATION.
